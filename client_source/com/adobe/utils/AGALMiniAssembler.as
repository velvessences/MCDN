   ...
   public class AGALMiniAssembler
   {
      ...
      public function assemble(param1:String, param2:String, param3:uint = 1, param4:Boolean = false) : ByteArray
      {
         ...
         while(_loc43_ < _loc32_ && _error == "")
         {
            ...
            _loc22_ = int(_loc30_.search("//"));
            if(_loc22_ != -1)
            {
               _loc30_ = _loc30_.slice(0,_loc22_);
            }
            _loc28_ = int(_loc30_.search(/<.*>/g));
            if(_loc28_ != -1)
            {
            ...
            else
            {
               ...
               else
               {
                  ...
                  while(_loc41_ < _loc29_)
                  {
                     ...
                     _loc33_ = _loc41_ == 0 && !(_loc10_.flags & 0x80);
                     ...
                     else if(_loc7_)
                     {
                        ...
                        while(_loc42_ < _loc13_)
                        {
                           ...
                           else
                           {
                              if(_loc45_.flag != 16)
                              {
                                 _loc46_ &= ~(15 << _loc45_.flag);
                              }
                              _loc46_ |= _loc45_.mask << _loc45_.flag;
                           }
                           _loc42_++;
                        }
                        agalcode.writeShort(_loc19_);
                     ...
                     else
                     {
                        ...
                        agalcode.writeShort(_loc35_ ? _loc20_ | 0x8000 : 0);
                        _loc39_ -= 64;
                     }
                     _loc41_++;
                  }
      ...
      {
         REGMAP["va"] = new Register("va","vertex attribute",0,param2 ? 1024 : 7,0x40 | 2);
         REGMAP["vc"] = new Register("vc","vertex constant",1,param2 ? 1024 : (param1 == 1 ? 127 : 249),0x40 | 2);
         REGMAP["vt"] = new Register("vt","vertex temporary",2,param2 ? 1024 : (param1 == 1 ? 7 : 25),0x40 | 1 | 2);
         REGMAP["vo"] = new Register("vo","vertex output",3,param2 ? 1024 : 0,0x40 | 1);
         REGMAP["vi"] = new Register("vi","varying",4,param2 ? 1024 : (param1 == 1 ? 7 : 9),0x40 | 0x20 | 2 | 1);
         REGMAP["fc"] = new Register("fc","fragment constant",1,param2 ? 1024 : (param1 == 1 ? 27 : 63),0x20 | 2);
         REGMAP["ft"] = new Register("ft","fragment temporary",2,param2 ? 1024 : (param1 == 1 ? 7 : 25),0x20 | 1 | 2);
         REGMAP["fs"] = new Register("fs","texture sampler",5,param2 ? 1024 : 7,0x20 | 2);
         REGMAP["fo"] = new Register("fo","fragment output",3,param2 ? 1024 : (param1 == 1 ? 0 : 3),0x20 | 1);
         REGMAP["fd"] = new Register("fd","fragment depth output",6,param2 ? 1024 : (param1 == 1 ? -1 : 0),0x20 | 1);
         REGMAP["op"] = REGMAP["vo"];
         REGMAP["i"] = REGMAP["vi"];
         REGMAP["v"] = REGMAP["vi"];
         REGMAP["oc"] = REGMAP["fo"];
