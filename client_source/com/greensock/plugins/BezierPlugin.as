      ...
      public static function _parseBezierData(param1:Array, param2:String, param3:Object = null) : Object
      {
         ...
         while(--_loc13_ > -1)
         {
            ...
            while(_loc14_ < _loc15_)
            {
               ...
               _loc7_ = param3 == null ? Number(param1[_loc14_][_loc16_]) : (typeof _loc18_ === "string" && _loc18_.charAt(1) === "=" ? param3[_loc16_] + Number(_loc18_.charAt(0) + _loc18_.substr(2)) : Number(Number(_loc18_)));
               if(_loc6_)
               {
                  if(_loc14_ > 1)
                  {
