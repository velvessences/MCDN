package com.greensock.plugins
{
   ...
   public class ShortRotationPlugin extends TweenPlugin
   {
      ...
      override public function _onInitTween(param1:Object, param2:*, param3:TweenLite) : Boolean
      {
         ...
         var _loc4_:Boolean = Boolean(Boolean(param2.useRadians == true));
         for(_loc6_ in param2)
         {
            if(_loc6_ != "useRadians")
            {
               ...
               _initRotation(param1,_loc6_,_loc5_,typeof param2[_loc6_] == "number" ? Number(Number(param2[_loc6_])) : _loc5_ + Number(param2[_loc6_].split("=").join("")),_loc4_);
            }
         }
         return true;
      }
