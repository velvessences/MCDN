package com.moviestarplanet.valueObjects
{
   ...
   internal class _FriendListItemEntityMetadata extends AbstractEntityMetadata
   {
      ...
      model_internal static var allProperties:Array = new Array("actorId","name","membershipTimeoutDate");
      
      model_internal static var allAssociationProperties:Array = new Array();
      
      model_internal static var allRequiredProperties:Array = new Array();
      
      model_internal static var allAlwaysAvailableProperties:Array = new Array("actorId","name","membershipTimeoutDate");
      
      model_internal static var guardedProperties:Array = new Array();
      
      model_internal static var dataProperties:Array = new Array("actorId","name","membershipTimeoutDate");
      
      model_internal static var sourceProperties:Array = emptyArray;
      
      model_internal static var nonDerivedProperties:Array = new Array("actorId","name","membershipTimeoutDate");
      
      model_internal static var derivedProperties:Array = new Array();
      
      model_internal static var collectionProperties:Array = new Array();
      
      model_internal static var entityName:String = "FriendListItem";
      
      model_internal static var dependedOnServices:Array = new Array();
      
      model_internal static var _nullStyle:Style = new Style();
      
      model_internal var _instance:_Super_FriendListItem;
      
      public function _FriendListItemEntityMetadata(param1:_Super_FriendListItem)
      {
         super();
      ...
      override public function getDependants(param1:String) : Array
      {
         ...
         {
            throw new Error(param1 + " is not a data property of entity FriendListItem");
         }
      ...
      override public function getCollectionBase(param1:String) : String
      {
         ...
         {
            throw new Error(param1 + " is not a collection property of entity FriendListItem");
         }
      ...
      override public function getPropertyType(param1:String) : String
      {
         ...
         {
            throw new Error(param1 + " is not a property of FriendListItem");
         }
      ...
      override public function getValue(param1:String) : *
      {
         if(allProperties.indexOf(param1) == -1)
         {
            throw new Error(param1 + " does not exist for entity FriendListItem");
         }
      ...
      override public function setValue(param1:String, param2:*) : void
      {
         if(nonDerivedProperties.indexOf(param1) == -1)
         {
            throw new Error(param1 + " is not a modifiable property of entity FriendListItem");
         }
