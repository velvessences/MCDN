package com.moviestarplanet.valueObjects
{
   ...
   public class _Super_ClipArtCategoryObject extends EventDispatcher implements IValueObject
   {
      
      private static var emptyArray:Array = new Array();
      
      model_internal var _dminternal_model:_ClipArtCategoryObjectEntityMetadata;
      ...
      public function _Super_ClipArtCategoryObject()
      {
         super();
         this._model = new _ClipArtCategoryObjectEntityMetadata(this);
      }
      ...
      {
         var _loc2_:int = this._internal_type;
         if(_loc2_ !== param1)
         {
            this._internal_type = param1;
            this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"type",_loc2_,this._internal_type));
         }
      }
      ...
      [Bindable(event="propertyChange")]
      [Transient]
      public function get _model() : _ClipArtCategoryObjectEntityMetadata
      {
         return this._dminternal_model;
      }
      
      public function set _model(param1:_ClipArtCategoryObjectEntityMetadata) : void
      {
         var _loc2_:_ClipArtCategoryObjectEntityMetadata = this._dminternal_model;
         if(_loc2_ !== param1)
         {
