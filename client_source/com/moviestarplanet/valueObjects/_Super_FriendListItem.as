package com.moviestarplanet.valueObjects
{
   ...
   public class _Super_FriendListItem extends EventDispatcher implements IValueObject
   {
      
      private static var emptyArray:Array = new Array();
      
      model_internal var _dminternal_model:_FriendListItemEntityMetadata;
      ...
      public function _Super_FriendListItem()
      {
         super();
         this._model = new _FriendListItemEntityMetadata(this);
      }
      ...
      [Bindable(event="propertyChange")]
      [Transient]
      public function get _model() : _FriendListItemEntityMetadata
      {
         return this._dminternal_model;
      }
      
      public function set _model(param1:_FriendListItemEntityMetadata) : void
      {
         var _loc2_:_FriendListItemEntityMetadata = this._dminternal_model;
         if(_loc2_ !== param1)
         {
