   ...
   public class Scale9Image extends Sprite implements IValidating
   {
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         else
         {
            ...
            _loc5_ = _loc5_ < HELPER_POINT.x ? _loc5_ : Number(HELPER_POINT.x);
            _loc4_ = _loc4_ > HELPER_POINT.x ? _loc4_ : Number(HELPER_POINT.x);
            _loc6_ = _loc6_ < HELPER_POINT.y ? _loc6_ : Number(HELPER_POINT.y);
            _loc3_ = _loc3_ > HELPER_POINT.y ? _loc3_ : Number(HELPER_POINT.y);
