package feathers.textures
{
   ...
   public final class Scale9Textures
   {
      ...
      public function Scale9Textures(param1:Texture, param2:Rectangle)
      {
         ...
         {
            throw new ArgumentError("The sum of the x and width properties of the scale9Grid must be less than or equal to the width of the texture.");
         }
         if(param2.y + param2.height > _loc3_.height)
         {
            throw new ArgumentError("The sum of the y and height properties of the scale9Grid must be less than or equal to the height of the texture.");
         }
      ...
      private function initialize() : void
      {
         ...
         var _loc25_:Number = Number(this._scale9Grid.x);
         var _loc16_:Number = Number(this._scale9Grid.width);
         var _loc31_:Number = _loc20_.width - this._scale9Grid.width - this._scale9Grid.x;
         var _loc23_:Number = Number(this._scale9Grid.y);
         var _loc28_:Number = Number(this._scale9Grid.height);
         ...
         var _loc6_:Boolean = _loc7_ != _loc25_;
         var _loc12_:Boolean = _loc18_ != _loc23_;
         var _loc10_:Boolean = _loc26_ != _loc31_;
         var _loc4_:Boolean = _loc30_ != _loc11_;
