package fl.text
{
   ...
   internal class SingleTextContainerManager extends CommonTextContainerManager implements IContainerManager
   {
      ...
      public function SingleTextContainerManager(param1:Sprite, param2:TLFTextField, param3:ContainerController = null)
      {
         super();
         _controller = param3;
         _container = param1;
      ...
      override public function getTextFormat(param1:int, param2:int) : TextFormat
      {
         ...
         {
            _loc7_ = Number(Number.NaN);
            _loc8_ = _loc4_.lineHeight;
            if(_loc8_)
            {
               if(_loc8_.indexOf("%") == -1)
               {
                  _loc7_ = Number(Number(_loc8_));
               }
               else
               {
                  _loc9_ = Number(_loc4_.fontSize);
         ...
         {
            _loc10_ = int(_loc4_.tabStops.length);
            _loc11_ = 0;
      ...
      override public function setTextFormat(param1:TextFormat, param2:int, param3:int, param4:TextLayoutFormat, param5:TextLayoutFormat) : void
      {
         ...
         if(!this.isTextStringAndFormat() || param1.url != null || param1.target != null)
         {
