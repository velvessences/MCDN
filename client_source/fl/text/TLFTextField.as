package fl.text
{
   ...
   public class TLFTextField extends Sprite
   {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static const INVALID_NONE:uint = 0;
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static const INVALID_TEXT:uint = 1;
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static const INVALID_DIMENSIONS:uint = 2;
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static const INVALID_BORDER:uint = 4;
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static const INVALID_WORD_WRAP:uint = 8;
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static const INVALID_SELECTION:uint = 16;
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static const INVALID_AUTO_SIZE:uint = 32;
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static const INVALID_TYPE:uint = 64;
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static const INVALID_ALL:uint = INVALID_TEXT | INVALID_DIMENSIONS | INVALID_BORDER | INVALID_WORD_WRAP | INVALID_SELECTION | INVALID_AUTO_SIZE | INVALID_TYPE;
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static var alwaysShowSelectionOnFormat:SelectionFormat = new SelectionFormat(14937852,1,"normal",0,0,"normal",0);
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static var alwaysShowSelectionOffFormat:SelectionFormat = new SelectionFormat(12047870,0,"normal",0,0,"normal",0);
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static var focusedSelectionFormat:SelectionFormat = new SelectionFormat(12047870,1,"normal",0,1,"normal",500);
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static var inactiveSelectionFormat:SelectionFormat = new SelectionFormat(12047870,0,"normal",0,0,"normal",0);
      
      protected static var useTCM:Boolean = true;
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static var genericFonts:Array = ["_sans","_serif","_typewriter","_gothic","_gothicMono","_mincho","_ゴシック","_等幅","_明朝"];
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static var _initialDefaultTextFormat:TextFormat = new TextFormat("Times New Roman",12,0,false,false,false,"","",TextFormatAlign.LEFT,0,0,0,null);
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") var _alwaysShowSelection:Boolean;
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static function repeat(param1:String, param2:String) : String
      {
         var _loc3_:String = "";
         var _loc4_:int = 0;
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") static function createTextLayoutFormat(param1:TextFormat) : TextLayoutFormat
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function set contentHeight(param1:Number) : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function setCompositionSize(param1:Number, param2:Number) : void
      {
         this._containerManager.setCompositionSize(param1,param2);
      }
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function repaint(param1:Event = null) : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function doImport(param1:String, param2:String) : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function getEditingMode(param1:ISelectionManager) : String
      {
         return param1 ? param1.editingMode : EditingMode.READ_ONLY;
      }
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get firstField() : TLFTextField
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function addNextField(param1:TLFTextField) : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function textFlow_ScrollHandler(param1:TextLayoutEvent) : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function set generationID(param1:int) : void
      {
         this._generationID = param1;
      }
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get usesTCM() : Boolean
      {
         return this._containerManager is SingleTextContainerManager;
      }
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function textFlow_flowOperationEndHandler(param1:FlowOperationEvent) : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get minScrollV() : int
      {
      ...
      public function get bottomScrollV() : int
      {
         ...
         var _loc2_:int = int(_loc1_.findLineIndexAtPosition(this._containerManager.absoluteStart));
         ...
         while(_loc6_ >= _loc2_)
         {
            ...
            if(Boolean(_loc7_.textLineExists) && Boolean(_loc7_.getTextLine().parent))
            {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get prevField() : TLFTextField
      {
         var _loc1_:int = 0;
         var _loc2_:TLFContainerController = null;
         if(Boolean(this.textFlow) && Boolean(this.textFlow.flowComposer))
         {
            _loc1_ = int(this.textFlow.flowComposer.getControllerIndex(this.controller));
            if(_loc1_ > 0)
            {
      ...
      public function get textWidth() : Number
      {
         ...
         var _loc1_:Number = isNaN(Number(this.paddingLeft)) ? 0 : Number(Number(this.paddingLeft));
         var _loc2_:Number = isNaN(Number(this.paddingRight)) ? 0 : Number(Number(this.paddingRight));
      ...
      public function get textHeight() : Number
      {
         this.repaint();
         this._containerManager.compose();
         var _loc1_:Number = isNaN(Number(this.paddingTop)) ? 0 : Number(Number(this.paddingTop));
         var _loc2_:Number = isNaN(Number(this.paddingBottom)) ? 0 : Number(Number(this.paddingBottom));
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get passwordCharacter() : String
      {
         return this._passwordCharacter;
      }
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get contentWidth() : Number
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get isPointText() : Boolean
      {
         return this._isPointText && (this.TCMUsesTextStringAndFormat || this.textFlow != null);
      }
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function initController(param1:Sprite) : TLFContainerController
      {
         this._containerManager.addListeners();
         return new TLFContainerController(param1,this);
      }
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get paddingLock() : Boolean
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get inlineInfo() : *
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function composeComplete(param1:CompositionCompleteEvent) : void
      {
         var _loc3_:Number = NaN;
         var _loc4_:Number = NaN;
         if(Boolean(param1) && Boolean(!this.TCMUsesTextStringAndFormat) && param1.target as TextFlow != this.textFlow)
         {
            return;
         }
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get contentHeight() : Number
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function switchToEditingMode(param1:TextFlow, param2:String, param3:Boolean = true) : void
      {
      ...
      public function get maxScrollV() : int
      {
         ...
         var _loc10_:Boolean = _loc1_.blockProgression == BlockProgression.RL;
         if(_loc10_)
         {
            _loc9_ = Number(Math.round(Math.min(this._maxScrollVLastLineRect.left,this._containerManager.contentLeft) + this._containerManager.compositionWidth));
            if(_loc9_ >= 0)
            {
               this._maxScrollVCached = true;
               this._maxScrollV = 0;
         ...
         {
            _loc9_ = Number(Math.round(Math.max(this._maxScrollVLastLineRect.bottom,this._containerManager.contentHeight) - this._containerManager.compositionHeight));
            if(_loc9_ <= 0)
            {
               this._maxScrollVCached = true;
               this._maxScrollV = 0;
      ...
      public function get scrollV() : int
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(!_loc4_.isEmpty())
            {
               if(_loc1_.blockProgression == BlockProgression.RL)
               {
                  _loc5_ = Number(Math.round(this._containerManager.horizontalScrollPosition));
               ...
               {
                  _loc6_ = Number(Math.round(this._containerManager.verticalScrollPosition));
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function updateComplete(param1:UpdateCompleteEvent) : void
      {
      ...
      public function getCharBoundaries(param1:int) : Rectangle
      {
         ...
         var _loc5_:int = int(_loc4_.getAtomIndexAtCharIndex(param1 - _loc3_.paragraph.getAbsoluteStart()));
         if(_loc5_ > -1)
         {
         ...
         var _loc9_:Boolean = _loc8_ == BlockProgression.RL;
         if(!_loc9_)
         {
            _loc2_.x += _loc7_.x;
            _loc2_.y = _loc7_.y;
      ...
      public function replaceSelectedText(param1:String) : void
      {
         ...
         var _loc4_:Number = Number(_loc3_.anchorPosition);
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function invalidate(param1:uint) : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function insertWithParagraphs(param1:EditManager, param2:String) : void
      {
         var _loc3_:Array = null;
         var _loc4_:Number = NaN;
         ...
         {
            _loc3_ = param2.split("\n");
            _loc4_ = Number(param1.absoluteStart);
            _loc5_ = _loc3_.shift();
            while(_loc5_ != null)
            {
               if(_loc5_.length)
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function removeTextFlowEventListeners() : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function set hostFormat(param1:ITextLayoutFormat) : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function textFlow_flowOperationBeginHandler(param1:FlowOperationEvent) : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get pixelMinScrollV() : int
      {
         return 0;
      }
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function set contentWidth(param1:Number) : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function addTextFlowEventListeners() : void
      {
         this._containerManager.addListeners();
      }
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function set isPointText(param1:Boolean) : void
      {
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get TCMUsesTextStringAndFormat() : Boolean
      {
         return this._containerManager.isTextStringAndFormat();
      }
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get hostFormat() : ITextLayoutFormat
      {
      ...
      public function getParagraphLength(param1:int) : int
      {
         ...
         if(_loc3_)
         {
            _loc2_ = int(_loc3_.paragraph.textLength);
         }
         return _loc2_;
      }
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function get nextField() : TLFTextField
      {
         var _loc1_:int = 0;
         var _loc2_:TLFContainerController = null;
         if(Boolean(this.textFlow) && Boolean(this.textFlow.flowComposer))
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function set inlineInfo(param1:*) : void
      {
         this._inlineInfo = param1;
      }
      
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function set paddingLock(param1:Boolean) : void
      {
      ...
      public function getCharIndexAtPoint(param1:Number, param2:Number) : int
      {
         ...
         if(_loc3_)
         {
            ...
            _loc5_ = int(SelectionManager.computeSelectionIndex(_loc3_,this,null,_loc4_.x,_loc4_.y));
            _loc6_ = this.getCharBoundaries(_loc5_);
            return _loc6_.containsPoint(_loc4_) ? _loc5_ : (_loc5_ > 0 ? int(_loc5_ - 1) : _loc5_);
         }
         return -1;
      }
      ...
      §§namespace("http://ns.adobe.com/textLayout/internal/2008") function linkClick(param1:FlowElementMouseEvent) : void
      {
