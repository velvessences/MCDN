package fl.text.container
{
   ...
   public class TLFContainerController extends ContainerController
   {
      ...
      override §§namespace("http://ns.adobe.com/textLayout/internal/2008") function attachTransparentBackgroundForHit(param1:Boolean) : void
      {
         ...
         if(attachTransparentBackground)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               else
               {
                  ...
                  _loc6_ = _loc5_ ? horizontalScrollPosition - _loc3_ : Number(horizontalScrollPosition);
                  _loc7_ = Number(verticalScrollPosition);
