package mx.collections
{
   ...
   public class ListCollectionView extends Proxy implements ICollectionView, IList, IMXMLObject
   {
      ...
      override flash_proxy function getProperty(param1:*) : *
      {
         ...
         try
         {
            _loc3_ = Number(parseInt(String(param1)));
            if(!isNaN(_loc3_))
            {
               _loc2_ = int(int(_loc3_));
            }
         }
         catch(e:Error)
         {
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         try
         {
            _loc4_ = Number(parseInt(String(param1)));
            if(!isNaN(_loc4_))
            {
               _loc3_ = int(int(_loc4_));
            }
         }
         catch(e:Error)
         {
      ...
      private function addItemsToView(param1:Array, param2:int, param3:Boolean = true) : int
      {
         ...
         if(this.localIndex)
         {
            ...
            while(_loc8_ < param1.length)
            {
               ...
               if(this.filterFunction == null || Boolean(this.filterFunction(_loc9_)))
               {
                  if(this.sort)
                  {
                  ...
                  if(Boolean(this.sort) && Boolean(this.sort.unique) && this.sort.compareFunction(_loc9_,this.localIndex[_loc7_]) == 0)
                  {
