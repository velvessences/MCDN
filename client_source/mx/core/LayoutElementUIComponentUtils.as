   ...
   public class LayoutElementUIComponentUtils
   {
      ...
      private static function getMinUBoundsWidth(param1:IUIComponent) : Number
      {
         ...
         else
         {
            ...
            {
               _loc2_ = Number(Math.min(_loc2_,param1.explicitMaxWidth));
            }
         }
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
         {
      ...
      private static function getMinUBoundsHeight(param1:IUIComponent) : Number
      {
         ...
         else
         {
            ...
            {
               _loc2_ = Number(Math.min(_loc2_,param1.explicitMaxHeight));
            }
         }
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
         {
      ...
      public static function getPreferredBoundsWidth(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(param2)
         {
            _loc3_ = Number(MatrixUtil.transformSize(_loc3_,getPreferredUBoundsHeight(param1),param2).x);
         }
         return _loc3_;
      }
      ...
      public static function getPreferredBoundsHeight(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(param2)
         {
            _loc3_ = Number(MatrixUtil.transformSize(getPreferredUBoundsWidth(param1),_loc3_,param2).y);
         }
         return _loc3_;
      }
      ...
      public static function getMinBoundsWidth(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(param2)
         {
            _loc3_ = Number(MatrixUtil.transformSize(_loc3_,getMinUBoundsHeight(param1),param2).x);
         }
         return _loc3_;
      }
      ...
      public static function getMinBoundsHeight(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(param2)
         {
            _loc3_ = Number(MatrixUtil.transformSize(getMinUBoundsWidth(param1),_loc3_,param2).y);
         }
         return _loc3_;
      }
      ...
      public static function getMaxBoundsWidth(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(param2)
         {
            _loc3_ = Number(MatrixUtil.transformSize(_loc3_,getMaxUBoundsHeight(param1),param2).x);
         }
         return _loc3_;
      }
      ...
      public static function getMaxBoundsHeight(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(param2)
         {
            _loc3_ = Number(MatrixUtil.transformSize(getMaxUBoundsWidth(param1),_loc3_,param2).y);
         }
         return _loc3_;
      }
      ...
      public static function getLayoutBoundsWidth(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(param2)
         {
            ...
            _loc3_ = Number(MatrixUtil.transformBounds(_loc3_,_loc4_,param2,new Point()).x);
         }
         return _loc3_;
      }
      ...
      public static function getLayoutBoundsHeight(param1:IUIComponent, param2:Matrix) : Number
      {
         ...
         if(param2)
         {
            ...
            _loc3_ = Number(MatrixUtil.transformBounds(_loc4_,_loc3_,param2,new Point()).y);
         }
         return _loc3_;
      }
