package mx.core
{
   ...
   public class UIComponent extends FlexSprite implements IAutomationObject, IChildList, IConstraintClient, IDeferredInstantiationUIComponent, IFlexDisplayObject, IFlexModule, IInvalidating, ILayoutManagerClient, IPropertyChangeNotifier, IRepeaterClient, IStateClient, IAdvancedStyleClient, IToolTipManagerClient, IUIComponent, IValidatorListener, IVisualElement
   {
      ...
      override public function set scaleX(param1:Number) : void
      {
         ...
         {
            _loc2_ = this._layoutFeatures == null ? this.scaleX : this._layoutFeatures.layoutScaleX;
            if(_loc2_ == param1)
            {
               return;
            }
      ...
      override public function set scaleY(param1:Number) : void
      {
         ...
         {
            _loc2_ = this._layoutFeatures == null ? this.scaleY : this._layoutFeatures.layoutScaleY;
            if(_loc2_ == param1)
            {
               return;
            }
      ...
      public function set designLayer(param1:DesignLayer) : void
      {
         ...
         this.$alpha = this._designLayer ? this._alpha * this._designLayer.effectiveAlpha : this._alpha;
         this.$visible = this.designLayer ? this._visible && this._designLayer.effectiveVisibility : this._visible;
      }
      ...
      private function setBorderColorForErrorString() : void
      {
         ...
         var _loc1_:Boolean = FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0 || Boolean(this.getStyle("showErrorSkin"));
         if(_loc1_)
         {
            ...
            if(Boolean(_loc2_) && Boolean(_loc2_.showFocusIndicator) && _loc3_ == this)
            {
               this.drawFocus(true);
            }
         }
      ...
      override public function addChild(param1:DisplayObject) : DisplayObject
      {
         ...
         var _loc3_:int = Boolean(this.effectOverlayReferenceCount) && param1 != this.effectOverlay ? int(Math.max(0,super.numChildren - 1)) : int(super.numChildren);
      ...
      override public function addChildAt(param1:DisplayObject, param2:int) : DisplayObject
      {
         ...
         if(Boolean(this.effectOverlayReferenceCount) && param1 != this.effectOverlay)
         {
            param2 = int(Math.min(param2,Math.max(0,super.numChildren - 1)));
         }
         this.addingChild(param1);
      ...
      override public function setChildIndex(param1:DisplayObject, param2:int) : void
      {
         if(Boolean(this.effectOverlayReferenceCount) && param1 != this.effectOverlay)
         {
            param2 = int(Math.min(param2,Math.max(0,super.numChildren - 2)));
         }
      ...
      {
         if(Boolean(param1 && param1.instanceIndices) && (Boolean(!param1.isDocument || param1 != this.descriptor.document)) && !this._instanceIndices)
         {
      ...
      public function invalidateLayoutDirection() : void
      {
         ...
         if(this._layoutFeatures ? _loc3_ != this._layoutFeatures.mirror : _loc3_)
         {
            if(this._layoutFeatures == null)
            {
               this.initAdvancedLayoutFeatures();
      ...
      public function callLater(param1:Function, param2:Array = null) : void
      {
         ...
         if(Boolean(_loc3_) && (Boolean(_loc3_.stage) || Boolean(this.usingBridge)))
         {
      ...
      {
         var _loc1_:ISystemManager = this.systemManager;
         if(Boolean(_loc1_) && (Boolean(_loc1_.stage) || Boolean(this.usingBridge)))
         {
            if(this.listeningForRender)
            {
      ...
      protected function commitProperties() : void
      {
         ...
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
         {
            ...
            {
               _loc1_ = Number(Math.abs(this._scaleX / this.oldScaleX));
               if(!isNaN(this.explicitMinWidth))
               {
            ...
            {
               _loc2_ = Number(Math.abs(this._scaleY / this.oldScaleY));
               if(!isNaN(this.explicitMinHeight))
               {
         ...
         if(FlexVersion.compatibilityVersion >= FlexVersion.VERSION_4_0)
         {
            ...
            if(this.oldLayoutDirection != this.layoutDirection || this.parentChangedFlag || Boolean(_loc4_) && Boolean(_loc4_.layoutDirection != _loc4_.oldLayoutDirection))
            {
      ...
      mx_internal function measureSizes() : Boolean
      {
         ...
         {
            _loc4_ = Number(Math.abs(this.scaleX));
            _loc5_ = Number(Math.abs(this.scaleY));
            if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
            {
               if(_loc4_ != 1)
               {
      ...
      mx_internal function adjustSizesForScaleChanges() : void
      {
         ...
         if(_loc1_ != this.oldScaleX)
         {
            if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
            {
               _loc3_ = Number(Math.abs(_loc1_ / this.oldScaleX));
         ...
         if(_loc2_ != this.oldScaleY)
         {
            if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
            {
               _loc3_ = Number(Math.abs(_loc2_ / this.oldScaleY));
      ...
      protected function adjustFocusRect(param1:DisplayObject = null) : void
      {
         ...
         {
            _loc2_ = Number(param1.width);
            _loc3_ = Number(param1.height);
         }
         if(Boolean(isNaN(_loc2_)) || Boolean(isNaN(_loc3_)))
         {
            return;
         }
         ...
         if(_loc5_)
         {
            _loc7_ = FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0 || Boolean(this.getStyle("showErrorSkin"));
            if(Boolean(this.errorString) && Boolean(this.errorString != "") && _loc7_)
            {
      ...
      {
         var _loc3_:uint = uint(param1.keyCode);
         switch(_loc3_)
         {
            case Keyboard.DOWN:
               if(param2 && this.layoutDirection == LayoutDirection.RTL)
               {
                  _loc3_ = uint(Keyboard.LEFT);
               }
               break;
            case Keyboard.RIGHT:
      ...
      private function commitCurrentState() : void
      {
         ...
         if(this.isBaseState(this._currentState) && Boolean(hasEventListener(FlexEvent.EXIT_STATE)))
         {
      ...
      {
         if(Boolean(this.currentCSSState) && Boolean(param1 != param2) && (this.styleManager.hasPseudoCondition(param1) || this.styleManager.hasPseudoCondition(param2)))
         {
      ...
      {
         if(Boolean(this.advanceStyleClientChildren) && Boolean(this.advanceStyleClientChildren[param1]))
         {
      ...
      public function notifyStyleChangeInChildren(param1:String, param2:Boolean) : void
      {
         ...
         var _loc7_:IAdvancedStyleClient = null;
         this.cachedTextFormat = null;
         var _loc3_:int = int(numChildren);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      mx_internal function initThemeColor() : Boolean
      {
         ...
         {
            if((_loc2_ === null || !this.styleManager.isValidStyleValue(_loc2_)) && (Boolean(_loc1_) && Boolean(!(_loc1_ is ISimpleStyleClient))))
            {
         ...
         if(_loc2_ !== null && Boolean(this.styleManager.isValidStyleValue(_loc2_)) && Boolean(isNaN(_loc3_)) && Boolean(isNaN(_loc4_)))
         {
      ...
      mx_internal function setThemeColor(param1:Object) : void
      {
         ...
         if(_loc2_ is String)
         {
            _loc2_ = Number(parseInt(String(param1)));
         }
         else
         {
            _loc2_ = Number(Number(param1));
         }
         if(isNaN(_loc2_))
         {
      ...
      {
         var _loc1_:int = int(this._effectsStarted.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      private function callLaterDispatcher2(param1:Event) : void
      {
         ...
         if(Boolean(_loc2_) && (Boolean(_loc2_.stage || this.usingBridge)) && this.listeningForRender)
         {
