   ...
   public class Effect extends EventDispatcher implements IEffect
   {
      ...
      public function createInstance(param1:Object = null) : IEffectInstance
      {
         ...
         if(_loc4_)
         {
            ...
            if(_loc5_)
            {
               _loc6_ = int(this.propertyChangesArray.length);
               _loc7_ = 0;
               while(_loc7_ < _loc6_)
               {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            if(_loc9_)
            {
               ...
               while(_loc7_ < _loc6_)
               {
                  ...
                  if(_loc10_ in param1[_loc5_].start && _loc12_ != _loc11_ && (!(_loc11_ is Number) || !(Boolean(isNaN(_loc12_)) && Boolean(isNaN(_loc11_)))))
                  {
               ...
               while(_loc7_ < _loc6_)
               {
                  ...
                  if(_loc13_ in param1[_loc5_].start && _loc15_ != _loc14_ && (!(_loc14_ is Number) || !(Boolean(isNaN(_loc15_)) && Boolean(isNaN(_loc14_)))) && _loc8_ is IStyleClient)
                  {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            if(_loc9_)
            {
               ...
               while(_loc7_ < _loc6_)
               {
                  ...
                  _loc11_ = param1[_loc5_].start[_loc10_];
                  _loc12_ = param1[_loc5_].end[_loc10_];
                  if(_loc10_ in param1[_loc5_].end && (!(_loc12_ is Number) || !(Boolean(isNaN(_loc12_)) && Boolean(isNaN(_loc11_)))))
                  {
               ...
               while(_loc7_ < _loc6_)
               {
                  ...
                  _loc14_ = param1[_loc5_].start[_loc13_];
                  _loc15_ = param1[_loc5_].end[_loc13_];
                  if(_loc13_ in param1[_loc5_].end && (!(_loc15_ is Number) || !(Boolean(isNaN(_loc15_)) && Boolean(isNaN(_loc14_)))) && _loc8_ is IStyleClient)
                  {
