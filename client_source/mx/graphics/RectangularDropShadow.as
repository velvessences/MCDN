package mx.graphics
{
   ...
   public class RectangularDropShadow
   {
      ...
      public function drawShadow(param1:Graphics, param2:Number, param3:Number, param4:Number, param5:Number) : void
      {
         ...
         param4 = Number(Math.ceil(param4));
         param5 = Number(Math.ceil(param5));
         ...
         {
            _loc15_ = Number(Math.min(this.tlRadius + _loc10_,_loc13_));
            _loc16_ = Number(Math.min(this.tlRadius + _loc11_,_loc12_));
         ...
         {
            _loc17_ = Number(Math.min(this.trRadius + _loc10_,_loc13_));
            _loc18_ = Number(Math.min(this.trRadius + _loc11_,_loc12_));
         ...
         {
            _loc19_ = Number(Math.min(this.blRadius + _loc10_,_loc13_));
            _loc20_ = Number(Math.min(this.blRadius + _loc11_,_loc12_));
            _loc14_.tx = param2 - _loc6_;
         ...
         {
            _loc21_ = Number(Math.min(this.brRadius + _loc10_,_loc13_));
            _loc22_ = Number(Math.min(this.brRadius + _loc11_,_loc12_));
            _loc14_.tx = param2 + param4 + _loc7_ - this.shadow.width;
            _loc14_.ty = param3 + param5 + _loc9_ - this.shadow.height;
            param1.beginBitmapFill(this.shadow,_loc14_,false);
