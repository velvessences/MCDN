      ...
      private function showCurrentCursor() : void
      {
         ...
         if(this.cursorList.length > 0)
         {
            if(!this.initialized)
            {
               ...
               if(!_loc2_ || Boolean(dispatchEvent(_loc2_)))
               {
            ...
            if(_loc1_.cursorID != this.currentCursorID)
            {
               ...
               if(this.currentCursor)
               {
                  ...
                  if(!_loc4_ || Boolean(dispatchEvent(_loc4_)))
                  {
                  ...
                  if(!_loc5_ || Boolean(dispatchEvent(_loc5_)))
                  {
         ...
         else
         {
            ...
            if(this.currentCursorID != CursorManager.NO_CURSOR)
            {
               ...
               if(!_loc6_ || Boolean(dispatchEvent(_loc6_)))
               {
               ...
               if(!_loc7_ || Boolean(dispatchEvent(_loc7_)))
               {
