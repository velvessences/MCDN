package mx.utils
{
   ...
   public class LoaderUtil
   {
      ...
      public static function normalizeURL(param1:LoaderInfo) : String
      {
         ...
         var _loc6_:uint = uint(LoaderUtil.urlFilters.length);
         var _loc7_:uint = 0;
         while(_loc7_ < _loc6_)
         {
      ...
      public static function createAbsoluteURL(param1:String, param2:String) : String
      {
         ...
         if(Boolean(param1) && !(param2.indexOf(":") > -1 || param2.indexOf("/") == 0 || param2.indexOf("\\") == 0))
         {
            ...
            _loc5_ = int(Math.max(param1.lastIndexOf("\\"),param1.lastIndexOf("/")));
            if(param2.indexOf("./") == 0)
            {
            ...
            else
            {
               while(param2.indexOf("../") == 0)
               {
                  ...
                  _loc5_ = int(Math.max(param1.lastIndexOf("\\",_loc5_ - 1),param1.lastIndexOf("/",_loc5_ - 1)));
               }
            }
            if(_loc5_ != -1)
            {
