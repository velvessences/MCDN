package mx.utils
{
   ...
   public final class MatrixUtil
   {
      ...
      public static function decomposeMatrix(param1:Vector.<Number>, param2:Matrix, param3:Number = 0, param4:Number = 0) : void
      {
         ...
         _loc5_ = Number(param2.a);
         _loc6_ = Number(param2.b);
         param1[3] = Math.sqrt(_loc5_ * _loc5_ + _loc6_ * _loc6_);
         _loc7_ = Number(param2.c);
         _loc8_ = Number(param2.d);
      ...
      public static function rectUnion(param1:Number, param2:Number, param3:Number, param4:Number, param5:Rectangle) : Rectangle
      {
         ...
         var _loc6_:Number = Number(Math.min(param5.left,param1));
         var _loc7_:Number = Number(Math.min(param5.top,param2));
         var _loc8_:Number = Number(Math.max(param5.right,param3));
         var _loc9_:Number = Number(Math.max(param5.bottom,param4));
         param5.x = _loc6_;
         param5.y = _loc7_;
      ...
      public static function getEllipseBoundingBox(param1:Number, param2:Number, param3:Number, param4:Number, param5:Matrix, param6:Rectangle = null) : Rectangle
      {
         ...
         var _loc7_:Number = Number(param5.a);
         var _loc8_:Number = Number(param5.b);
         var _loc9_:Number = Number(param5.c);
         var _loc10_:Number = Number(param5.d);
         if(param3 == 0 && param4 == 0)
         {
      ...
      public static function getQBezierSegmentBBox(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Matrix, param10:Rectangle) : Rectangle
      {
         ...
         param1 = Number(_loc11_.x);
         param2 = Number(_loc11_.y);
         _loc11_ = MatrixUtil.transformPoint(param3 * param7,param4 * param8,param9);
         param3 = Number(_loc11_.x);
         param4 = Number(_loc11_.y);
         _loc11_ = MatrixUtil.transformPoint(param5 * param7,param6 * param8,param9);
         param5 = Number(_loc11_.x);
         param6 = Number(_loc11_.y);
         var _loc12_:Number = Number(Math.min(param1,param5));
         var _loc13_:Number = Number(Math.max(param1,param5));
         var _loc14_:Number = Number(Math.min(param2,param6));
         var _loc15_:Number = Number(Math.max(param2,param6));
         ...
         if(_loc16_ != 0)
         {
            ...
            if(0 <= _loc18_ && _loc18_ <= 1)
            {
               ...
               _loc12_ = Number(Math.min(_loc19_,_loc12_));
               _loc13_ = Number(Math.max(_loc19_,_loc13_));
            }
         }
         ...
         if(_loc17_ != 0)
         {
            ...
            if(0 <= _loc20_ && _loc20_ <= 1)
            {
               ...
               _loc14_ = Number(Math.min(_loc21_,_loc14_));
               _loc15_ = Number(Math.max(_loc21_,_loc15_));
            }
         }
      ...
      {
         var _loc4_:Number = Number(param3.a);
         var _loc5_:Number = Number(param3.b);
         var _loc6_:Number = Number(param3.c);
         var _loc7_:Number = Number(param3.d);
         var _loc8_:Number = 0;
         var _loc9_:Number = 0;
         ...
         var _loc16_:Number = Number(Math.min(Math.min(_loc8_,_loc10_),Math.min(_loc12_,_loc14_)));
         var _loc17_:Number = Number(Math.max(Math.max(_loc8_,_loc10_),Math.max(_loc12_,_loc14_)));
         var _loc18_:Number = Number(Math.min(Math.min(_loc9_,_loc11_),Math.min(_loc13_,_loc15_)));
         var _loc19_:Number = Number(Math.max(Math.max(_loc9_,_loc11_),Math.max(_loc13_,_loc15_)));
      ...
      public static function transformBounds(param1:Number, param2:Number, param3:Matrix, param4:Point = null) : Point
      {
         ...
         var _loc5_:Number = Number(param3.a);
         var _loc6_:Number = Number(param3.b);
         var _loc7_:Number = Number(param3.c);
         var _loc8_:Number = Number(param3.d);
         var _loc9_:Number = 0;
         ...
         var _loc17_:Number = Number(Math.min(Math.min(_loc9_,_loc11_),Math.min(_loc13_,_loc15_)));
         var _loc18_:Number = Number(Math.max(Math.max(_loc9_,_loc11_),Math.max(_loc13_,_loc15_)));
         var _loc19_:Number = Number(Math.min(Math.min(_loc10_,_loc12_),Math.min(_loc14_,_loc16_)));
         var _loc20_:Number = Number(Math.max(Math.max(_loc10_,_loc12_),Math.max(_loc14_,_loc16_)));
         staticPoint.x = _loc18_ - _loc17_;
         staticPoint.y = _loc20_ - _loc19_;
         if(param4)
         {
            _loc21_ = Number(param3.tx);
            _loc22_ = Number(param3.ty);
            _loc23_ = Number(param4.x);
            _loc24_ = Number(param4.y);
      ...
      {
         var _loc4_:Number = Number(param3.projectionCenter.x);
         var _loc5_:Number = Number(param3.projectionCenter.y);
         ...
         var _loc10_:Number = Number(Math.max(Math.max(_loc6_.x,_loc7_.x),Math.max(_loc8_.x,_loc9_.x)));
         var _loc11_:Number = Number(Math.min(Math.min(_loc6_.x,_loc7_.x),Math.min(_loc8_.x,_loc9_.x)));
         var _loc12_:Number = Number(Math.max(Math.max(_loc6_.y,_loc7_.y),Math.max(_loc8_.y,_loc9_.y)));
         var _loc13_:Number = Number(Math.min(Math.min(_loc6_.y,_loc7_.y),Math.min(_loc8_.y,_loc9_.y)));
      ...
      public static function fitBounds(param1:Number, param2:Number, param3:Matrix, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number, param11:Number) : Point
      {
         ...
         var _loc12_:Number = param8 < MIN_MAX_TOLERANCE ? 0 : param8 - MIN_MAX_TOLERANCE;
         var _loc13_:Number = param9 < MIN_MAX_TOLERANCE ? 0 : param9 - MIN_MAX_TOLERANCE;
         ...
         if(!isNaN(param1) && !isNaN(param2))
         {
            ...
            if(!_loc16_)
            {
               ...
               if(_loc17_)
               {
                  _loc19_ = Number(transformSize(_loc17_.x,_loc17_.y,param3).y);
               ...
               if(_loc18_)
               {
                  _loc20_ = Number(transformSize(_loc18_.x,_loc18_.y,param3).x);
      ...
      private static function fitTBoundsWidth(param1:Number, param2:Matrix, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number) : Point
      {
         ...
         else if(Boolean(isNaN(param3)) && !isNaN(param4))
         {
      ...
      public static function calcUBoundsToFitTBoundsHeight(param1:Number, param2:Matrix, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Point
      {
         ...
         var _loc18_:Number = NaN;
         var _loc19_:Number = NaN;
         var _loc9_:Number = Number(param2.b);
         var _loc10_:Number = Number(param2.d);
         ...
         {
            _loc18_ = 1 / _loc11_;
            param3 = Number(Math.max(param5,Math.min(param7,param3)));
            _loc13_ = param3;
         ...
         {
            _loc19_ = 1 / _loc9_;
            _loc14_ = param4 = Number(Math.max(param6,Math.min(param8,param4)));
         ...
         _loc15_ = Number(param2.a);
         _loc16_ = Number(param2.c);
      ...
      public static function calcUBoundsToFitTBoundsWidth(param1:Number, param2:Matrix, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Point
      {
         ...
         var _loc18_:Number = NaN;
         var _loc19_:Number = NaN;
         var _loc9_:Number = Number(param2.a);
         var _loc10_:Number = Number(param2.c);
         if(-1e-9 < _loc9_ && _loc9_ < 1e-9)
         {
            _loc9_ = 0;
         }
         ...
         _loc15_ = Number(param2.b);
         _loc16_ = Number(param2.d);
         var _loc17_:Number = _loc15_ * _loc16_ >= 0 ? _loc16_ : -_loc16_;
         return solveEquation(_loc9_,_loc11_,param1,param5,param6,param7,param8,_loc15_,_loc17_);
      }
      ...
      private static function solveEquation(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number) : Point
      {
         ...
         var _loc15_:Number = Number(Math.max(param5,Math.min(_loc13_,_loc14_)));
         var _loc16_:Number = Number(Math.min(param7,Math.max(_loc13_,_loc14_)));
         ...
         if(_loc15_ <= _loc16_)
         {
            ...
            _loc11_ = Number(Math.max(_loc15_,Math.min(_loc11_,_loc16_)));
         ...
         _loc15_ = Number(Math.max(param5,Math.min(_loc13_,_loc14_)));
         _loc16_ = Number(Math.min(param7,Math.max(_loc13_,_loc14_)));
         if(_loc15_ <= _loc16_)
         {
            if(Math.abs(_loc17_) < 1e-9)
            {
      ...
      {
         var _loc16_:Point = null;
         var _loc8_:Number = Number(param3.a);
         var _loc9_:Number = Number(param3.b);
         var _loc10_:Number = Number(param3.c);
         var _loc11_:Number = Number(param3.d);
         ...
         if(Boolean((_loc16_) && param4 <= _loc16_.x && _loc16_.x <= param6 && param5 <= _loc16_.y && _loc16_.y <= param7) && Boolean(_loc8_ * _loc16_.x + _loc12_ * _loc16_.x >= 0) && _loc9_ * _loc16_.x + _loc13_ * _loc16_.y >= 0)
         {
            return _loc16_;
         }
         _loc16_ = solveSystem(_loc8_,_loc12_,_loc9_,_loc13_,param1,-param2);
      ...
      private static function getConcatenatedMatrixHelper(param1:DisplayObject, param2:Boolean, param3:DisplayObject) : Matrix
      {
         ...
         if(usesMarshalling == null)
         {
            ...
            if(!usesMarshalling && Boolean(ApplicationDomain.currentDomain.hasDefinition("mx.core.UIComponent")))
            {
               uiComponentClass = Class(ApplicationDomain.currentDomain.getDefinition("mx.core.UIComponent"));
            }
            if(!usesMarshalling && Boolean(ApplicationDomain.currentDomain.hasDefinition("mx.flash.UIMovieClip")))
            {
         ...
         while(Boolean(param1) && Boolean(param1.transform.matrix) && param1 != param3)
         {
            ...
            if(Boolean(usesMarshalling) && "moduleFactory" in param1)
            {
               ...
               if((Boolean(_loc8_)) && Boolean(_loc8_ !== lastModuleFactory) && "info" in _loc8_)
               {
                  _loc9_ = _loc8_["info"]()["currentDomain"];
                  if((Boolean(_loc9_)) && Boolean(_loc9_.hasDefinition("mx.core.UIComponent")))
                  {
                     uiComponentClass = Class(_loc9_.getDefinition("mx.core.UIComponent"));
                  }
                  if(Boolean(_loc9_) && Boolean(_loc9_.hasDefinition("mx.flash.UIMovieClip")))
                  {
