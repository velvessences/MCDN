package org.swiftsuspenders.mapping
{
   ...
   public class InjectionMapping implements ProviderlessMapping, UnsealedMapping
   {
      ...
      public function toProviderOf(param1:Class, param2:String = "") : UnsealedMapping
      {
         var _loc3_:DependencyProvider = this._creatingInjector.getMapping(param1,param2).getProvider();
         this.toProvider(_loc3_);
         return this;
      }
