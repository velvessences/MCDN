package starling.core
{
   ...
   public class Starling extends EventDispatcher
   {
      ...
      public function dispose() : void
      {
         ...
         var _loc2_:int = int(sAll.indexOf(this));
         if(_loc2_ != -1)
         {
      ...
      private function onTouch(param1:Event) : void
      {
         ...
         if(param1 is MouseEvent)
         {
            ...
            _loc6_ = Number(_loc2_.stageX);
            _loc9_ = Number(_loc2_.stageY);
            _loc3_ = 0;
         ...
         else
         {
            ...
            if(Mouse.supportsCursor && Boolean(_loc7_.isPrimaryTouchPoint))
            {
               return;
            }
            _loc6_ = Number(_loc7_.stageX);
            _loc9_ = Number(_loc7_.stageY);
            _loc3_ = int(_loc7_.touchPointID);
