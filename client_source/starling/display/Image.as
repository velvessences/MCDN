package starling.display
{
   ...
   public class Image extends Quad
   {
      ...
      public function Image(param1:Texture)
      {
         ...
         {
            _loc3_ = param1.frame;
            _loc4_ = Number(_loc3_ ? _loc3_.width : param1.width);
            _loc2_ = Number(_loc3_ ? _loc3_.height : param1.height);
      ...
      public function readjustSize() : void
      {
         ...
         var _loc3_:Number = Number(_loc2_ ? _loc2_.width : texture.width);
         var _loc1_:Number = Number(_loc2_ ? _loc2_.height : texture.height);
