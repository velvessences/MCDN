package starling.utils
{
   ...
   public class MatrixUtil
   {
      ...
      {
         var _loc6_:Number = Number(Math.sin(param2));
         var _loc5_:Number = Number(Math.cos(param2));
         var _loc7_:Number = Number(Math.sin(param3));
         var _loc4_:Number = Number(Math.cos(param3));
