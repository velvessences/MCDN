package starling.utils
{
   ...
   public class VertexData
   {
      ...
      public function setColorAndAlpha(param1:int, param2:uint, param3:Number) : void
      {
         ...
         mRawData[_loc4_] = (param2 >> 16 & 0xFF) / 255 * _loc5_;
         mRawData[int(_loc4_ + 1)] = (param2 >> 8 & 0xFF) / 255 * _loc5_;
         mRawData[int(_loc4_ + 2)] = (param2 & 0xFF) / 255 * _loc5_;
      ...
      public function setColor(param1:int, param2:uint) : void
      {
         ...
         mRawData[_loc3_] = (param2 >> 16 & 0xFF) / 255 * _loc4_;
         mRawData[int(_loc3_ + 1)] = (param2 >> 8 & 0xFF) / 255 * _loc4_;
         mRawData[int(_loc3_ + 2)] = (param2 & 0xFF) / 255 * _loc4_;
      }
      ...
      {
         var _loc4_:int;
         var _loc5_:int = _loc4_ = param1 * 8 + 0;
         var _loc6_:Number = mRawData[_loc5_] + param2;
      ...
      public function scaleAlpha(param1:int, param2:Number, param3:int = 1) : void
      {
         ...
         else
         {
            ...
            while(_loc5_ < param3)
            {
               ...
               var _loc7_:Number = mRawData[_loc6_] * param2;
      ...
      public function toString() : String
      {
         ...
         while(_loc4_ < numVertices)
         {
            ...
            _loc2_ += "  [Vertex " + _loc4_ + ": " + "x=" + _loc1_.x.toFixed(1) + ", " + "y=" + _loc1_.y.toFixed(1) + ", " + "rgb=" + getColor(_loc4_).toString(16) + ", " + "a=" + getAlpha(_loc4_).toFixed(2) + ", " + "u=" + _loc3_.x.toFixed(4) + ", " + "v=" + _loc3_.y.toFixed(4) + "]" + (_loc4_ == numVertices - 1 ? "\n" : ",\n");
            _loc4_++;
         }
         return _loc2_ + "]";
      }
      ...
      public function set numVertices(param1:int) : void
      {
         ...
         var _loc3_:int = int(mRawData.length);
         _loc4_ = _loc2_;
         while(_loc4_ < _loc3_)
         {
            mRawData[_loc4_] = 1;
